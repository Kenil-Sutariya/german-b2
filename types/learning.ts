...
export interface ProgressState { version: 2; completedTasks: string[]; dayStatuses: Record<string, DayStatus>; confidence: Record<string, Confidence>; difficultWords: string[]; testScores: Record<string, number>; exerciseProgress: Record<string, ExerciseProgress>; vocabularyProgress: Record<string, ExerciseProgress>; notes: { id: string; title: string; body: string; tag: string; updatedAt: string }[]; writingDrafts: Record<string, string>; currentWeek: number; streak: number; lastStudyDate: string; totalMinutes: number; onboardingComplete: boolean; notifications: AppNotification[]; settings: { dailyTarget: 30 | 45 | 55; studyDays: 5 | 6; showEnglish: boolean; sundayMode: "rest" | "catch-up"; notifications: NotificationSettings } }
